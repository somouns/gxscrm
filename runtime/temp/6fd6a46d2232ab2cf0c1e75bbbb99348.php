                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block ">
                            <div class="input-item layui-col-md3">
                                <input type="text" placeholder="请输入姓名" v-model="addObject.real_name" name="real_name" autocomplete="off" maxlength="6" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <!--性别-->
