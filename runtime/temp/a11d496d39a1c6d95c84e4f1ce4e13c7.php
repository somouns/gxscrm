            ...
            <div class="layui-row common-row">
                ...
                <div class="layui-col-md12 jur-top fl">
                    <div class="layui-form juf-form">
                        ...
                        <div class="example-handle handle-add">
                            <?php if(checkAuth('/admin/department/addbranch') == 'true'): ?>
                ...
                <table class="common-table" cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                    ...
                    <tr align="center" v-for="(item, index) in tableDataAll">
                        ...
                        <td>
                            <?php if(checkAuth('/admin/department/editbranch') == 'true'): ?>
                            <a class="audit-skip" href="javascript:;" @click="editDepartment(item.id, index)">编辑</a>
                            <?php else: endif; if(checkAuth('/admin/department/selectdown') == 'true'): ?>
                            <a class="audit-skip" data-type="tab" title="部门结构" :href='"/admin/department/editbranch?id=" + item.id'>部门结构</a>
                            <?php else: endif; if(checkAuth('/admin/department/delbranch') == 'true'): ?>
...
<script src="__ADMINJS__/app/departmentManage.js"></script>
</body>
</html>