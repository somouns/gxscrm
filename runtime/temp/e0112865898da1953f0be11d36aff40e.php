        ...
        <div class="layui-container finance-container">
            ...
            <div class="layui-row finance-row">
                ...
                <ul class="sign-list clearfix">
                    <li class="sign-item"><span class="sign-name">客户姓名：</span><span>{{examineList.customer_name}}</span>
                    </li>
                    ...
                    <li class="sign-item"><span class="sign-name">购买产品：</span><span>{{examineList.goods_name}}</span>
                    </li>
            ...
            <div class="layui-row finance-row">
                ...
                <ul id="financeCkeckBoxs" class="sign-list examine-list clearfix">
                    <!-- S -->
                    <li class="sign-item sign-examines" v-for="(item,index) in examineList.sales_process">
                        <span class="sign-name">{{item.title}}：</span>
                        <div class="first-communication" v-for="(list,i) in item.info">
                            <div class="examine-distance">
                                ...
                                <ul class="pull-right" v-for="product in list.product_info">
...
<script src="__ADMINJS__/app/examineManageAudit.js"></script>
</body>
</html>