...
<link rel="stylesheet" href="__ADMINCSS__/page/message-reminder.css" />
</head>
<body>
    	...
    	<div class="main-wrap">
            ...
            <div class="main">
    			<div class="layui-tab layui-tab-card">
    			  <ul class="layui-tab-title">
    			    <li  @click="getSontype(00)" class="sm-active" class="noactive" :data-type="00">全部<span class="main-num">{{allnewsNum}}</span></li>
...
<script src="__ADMINJS__/app/message.js"></script>
</body>
</html>