            ...
            <div class="layui-row common-row">
                    ...
                    <div class="juf-form">
                        <form action="" class="layui-form">
                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" name="start_time" class="layui-input" id="test-start" placeholder="yyyy-MM-dd hh-mm-ss">
                                    </div>
                                </div>
                                <span class="jur-line">-</span>
                                <div class="layui-inline">
                                    <div class="layui-input-inline">
                                        <input type="text" name="stop_time" class="layui-input" id="test-stop" placeholder="yyyy-MM-dd hh-mm-ss">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="example-handle handle-add">
                                <?php if(checkAuth('/admin/auth/group/addgroup') == 'true'): ?>
                ...
                <table class="common-table" cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                    ...
                    <tr align="center" v-for="item in tableDataAll">
                        ...
                        <td>
                            <?php if(checkAuth('/admin/auth/group/selectonegroup') == 'true'): ?>
                            <a class="audit-skip" data-type="tab" title="查看权限" :href='"/admin/auth/group/selectonegroup?id=" + item.id'>查看</a>
                            <?php else: endif; if(checkAuth('/admin/auth/group/editgroup') == 'true'): ?>
                            <a class="audit-skip" data-type="tab" title="编辑权限" :href='"/admin/auth/group/editgroup?id=" + item.id'>编辑</a>
                            <?php else: endif; if(checkAuth('/admin/auth/group/delgroup') == 'true'): ?>
...
<script src="__ADMINJS__/app/jurisdictionList.js"></script>
</body>
</html>