                    ...
                    <div class="layui-form juf-form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="stock_name" v-model="data.stock_name" lay-verify="" placeholder="请输入标题" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">产品名称</label>
                            <div class="layui-input-block">
                                <input type="text" name="product_name" v-model="data.product_name" lay-verify="" placeholder="请输入标题" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" class="layui-input" id="test-start" v-model="data.product_stock_create_time_start" placeholder="yyyy-MM-dd">
                                </div>
                            </div>
                            <span class="jur-line">~</span>
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" class="layui-input" id="test-stop" v-model="data.product_stock_create_time_end" placeholder="yyyy-MM-dd">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="product_stock_leader_name" v-model="data.product_stock_leader_name" lay-verify="" placeholder="请输入标题" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="example-handle">
                            <button class="examine-query">查询</button><button class="examine-reset">重置</button>
                        </div>
                        <div class="example-handle">
            ...
            <table class="common-table" cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                ...
                <tr align="center" v-for="(item, index) in tableDataAll">
                    ...
                    <td>
                        ...
                        <a class="audit-skip">删除</a>
                        <a class="audit-skip">出局</a>
