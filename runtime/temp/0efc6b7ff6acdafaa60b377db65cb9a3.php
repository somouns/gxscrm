        ...
        <div class="layui-container">
            <div class="layui-tab">
                <ul class="layui-tab-title init-tab">
                    <?php if(checkAuth('/admin/visit/visit/visit_lists') == 'true'): ?>
                    <li class="layui-this">待法务回访</li>
                    <?php endif; if(checkAuth('/admin/visit/visit/visit_record_list') == 'true'): ?>
                    <li>全部回访记录</li>
                    <?php endif; ?>
                </ul>
                <div class="layui-tab-content init-content">
                    ...
                    <div class="layui-tab-item content-list layui-show">
                        ...
                        <div class="layui-form-item finance-search">
                            <div class="layui-input-block">
                                <form action="" class="layui-form">
                                    <input type="text" name="title" lay-verify="" @blur="searchBlur" autocomplete="off" placeholder="请输入客户姓名、产品或销售人员" class="layui-input">
                        ...
                        <table class="common-table" cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                            ...
                            <tr align="center" v-for="item in tableDataAll">
                                ...
                                <td>
                                    <?php if(checkAuth('/admin/visit/visit/visit_view') == 'true'): ?>
                    ...
                    <div class="layui-tab-item content-list">
                        ...
                        <div class="layui-form-item finance-search">
                            <div class="layui-input-block">
                                <form action="" class="layui-form">
                                    <input type="text" name="title" lay-verify="keywords" @blur="searchBlur" autocomplete="off" placeholder="请输入客户姓名、产品或销售人员" class="layui-input">
...
<script src="__ADMINJS__/app/visitManage.js"></script>
</body>
</html>