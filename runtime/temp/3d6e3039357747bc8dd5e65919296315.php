        ...
        <div class="layui-container">
            <div class="layui-tab">
                <ul class="layui-tab-title init-tab">
                    <?php if(checkAuth('/admin/financial/financial/financial_lists') == 'true'): ?>
                    <li class="layui-this">待财务审核</li>
                    <?php endif; if(checkAuth('/admin/financial/financial/financial_record_list') == 'true'): ?>
                    <li>全部审核记录</li>
                    <?php endif; ?>
                </ul>
                    ...
                    <div class="layui-tab-item content-list layui-show">
                        ...
                        <div class="layui-form-item finance-search">
                            <div class="layui-input-block">
                                <form action="" class="layui-form">
                                    <input type="text" name="title" lay-verify="" @blur="searchBlur" autocomplete="off" placeholder="请输入客户姓名、产品名称或所属销售" class="layui-input">
                        ...
                        <table class="common-table" cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                            ...
                            <tr align="center" v-for="item in tableDataAll">
                                ...
                                <td>{{item.salesman}}</td>
                                <td>
                                    <?php if(checkAuth('/admin/financial/financial/financial_view') == 'true'): ?>
...
<script src="__ADMINJS__/app/financeManage.js"></script>
</body>
</html>