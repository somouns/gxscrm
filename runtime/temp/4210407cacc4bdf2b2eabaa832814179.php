                    ...
                    <div class="rule-list form-item">
                        <div class="add-import" v-for="item in dataAll">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" v-model="item.name" name="title" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">路由名称</label>
                                <div class="layui-input-block">
                                    <input type="text" v-model="item.title" name="title" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">备注</label>
                                <div class="layui-input-block">
                                    <input type="text" v-model="item.remark" name="title" required  lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="__ADMINJS__/app/rule.js"></script>
</body>
</html>