        ...
        <div class="layui-container finance-container">
            ...
            <div class="layui-row finance-row">
                ...
                <ul class="sign-list clearfix">
                    <li class="sign-item"><span class="sign-name">客户姓名：</span><span>{{contractList.customer_name}}</span></li>
                    <li class="sign-item"><span class="sign-name">购买产品：</span><span>{{contractList.goods_name}}</span></li>
                    <li class="sign-item"><span class="sign-name">购买数量：</span><span>{{contractList.pay_num}}</span></li>
                    <li class="sign-item"><span class="sign-name">付费金额：</span><span>{{contractList.pay_money}} 元</span></li>
                    <li class="sign-item"><span class="sign-name">服务期限：</span><span>{{contractList.days}} 个自然日</span></li>
...
<script src="__ADMINJS__/app/contractManageAudit.js"></script>
</body>
</html>