        ...
        <div class="layui-container finance-container">
            ...
            <div class="layui-row finance-row">
                ...
                <ul class="sign-list clearfix">
                    <li class="sign-item"><span class="sign-name">客户姓名：</span><span>{{visitList.customer_name}}</span></li>
                    <li class="sign-item"><span class="sign-name">身份证号：</span><span>{{visitList.id_card}}</span></li>
                    <li class="sign-item">
                        <span class="sign-name">购买电话：</span>
                        <div class="vis-phone">
                            <span class="sign-span" v-for="mobile in visitList.mobile">{{mobile.contact_way}}
                                <?php if(checkAuth('/admin/call/call/call') == 'true'): ?>
                                <i class="iconfont icon-phone" :data-id="mobile.contact_id" @click="cellPhone(mobile.contact_id)"></i>
                                <?php endif; ?>
                            </span>
                        </div>
                    </li>
                ...
                <ul class="sign-list clearfix">
                    <li class="sign-item"><span class="sign-name">购买产品：</span><span>{{visitList.goods_name}}</span></li>
                    <li class="sign-item"><span class="sign-name">购买数量：</span><span>{{visitList.pay_num}}</span></li>
                    <li class="sign-item"><span class="sign-name">付费金额：</span><span>{{visitList.pay_money}} 元</span></li>
                    <li class="sign-item"><span class="sign-name">服务期限：</span><span>{{visitList.days}} 个自然日</span></li>
                    <li class="sign-item"><span class="sign-name">支付方式：</span><span>{{visitList.pay_type == 1 ? '线上支付' : (visitList.pay_type == 2 ? '线下支付' : '******') }}</span></li>
                </ul>
                <ul class="sign-list clearfix">
                    ...
                    <li class="sign-item"><span class="sign-name">合规状态：</span><span>{{visitList.compliance_status == 1 ? '已合规' : (visitList.compliance_status == 2 ? '未合规' : '******') }}</span></li>
                </ul>
                <ul class="sign-list clearfix">
...
<script src="__ADMINJS__/app/visitManageAudit.js"></script>
</body>
</html>