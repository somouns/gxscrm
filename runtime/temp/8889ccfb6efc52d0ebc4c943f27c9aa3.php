                ...
                <div class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="username" disabled :value="BasicInfo.username" maxlength="30" minlength="4" lay-verify="required|uPattern" autocomplete="off" placeholder="4~30个字符；可使用字母、数字或下划线" class="layui-input" >
                        </div>
                    </div>
                    <!-- 密码 -->
                    <!--<div class="layui-form-item">-->
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block phone-box">
                            <div class="input-item">
                                <input type="text" name="mobile" :value="BasicInfo.mobile" @blur="checkmobile" :disabled="userdisabled" maxlength="11" lay-verify="required|tPattern" autocomplete="off" placeholder="请输入手机号" class="layui-input" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="nickname" :value="BasicInfo.nickname" maxlength="10" autocomplete="off" lay-verify="required" placeholder="请输入真实姓名" class="layui-input" >
                        </div>
                    </div>
                    <!-- 微信号 -->
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" placeholder="请输入坐席号" :value="BasicInfo.seat_number" name="seat_number" autocomplete="off" class="layui-input" >
                        </div>
                    </div>
                    <!-- 上传图片按钮 -->
                    <div class="layui-form-item">
...
<script src="__ADMINJS__/app/accountsManageEdit.js"></script>
</body>
</html>