                ...
                <div class="layui-form">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <select name="stock_name" required lay-verify="required" lay-search="" disabled>
                                ...
                                <p class="stock-price"><span>现价：12元</span><span>跌停价：12元</span><span>涨停价：12元</span></p>
                            </div>
                        </div>
                    </div>
                    <!-- 建仓价 -->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block phone-box">
                            <input type="text" name="stock_buy_price" required lay-verify="required" placeholder="2" class="layui-input" disabled>
                        </div>
                    </div>
                    <!-- 调仓比例 -->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="stock_position" required lay-verify="required|stockTest" @blur="stockScale" placeholder="3" class="layui-input" disabled>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block phone-box">
                            <input type="text" name="stock_win_price" required lay-verify="required" placeholder="" class="layui-input">
                        </div>
                    </div>
                    <!-- 止损价 -->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block phone-box">
                            <input type="text" name="stock_lose_price" required lay-verify="required" placeholder="" class="layui-input">
                        </div>
                    </div>
                    <!-- 标的负责人 -->
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="stock_suggestcontent" placeholder="" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <!-- 操作理由 -->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="stock_info" placeholder="" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <!-- 保存与取消 -->
                    <div class="examine">
...
<script src="__ADMINJS__/app/signManageEdit.js"></script>
</body>
</html>