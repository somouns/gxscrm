                    ...
                    <form class="layui-form">
                        ...
                        <div class="layui-form-item custom-label">
                            ...
                            <div class="layui-input-block">
                                <input type="text" :value="dataLists.name" disabled placeholder="权限组名称" autocomplete="off" class="layui-input username">
                            </div>
                        </div>
                        <div class="layui-form-item custom-label">
                            <label class="layui-form-label">描述：</label>
                            <div class="layui-input-block">
                                <textarea placeholder="描述内容" :value="dataLists.describe" disabled="" class="layui-textarea description"></textarea>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="data-jur">
                                ...
                                <li class="open" v-for="items in dataLists.datas">
                                    <div class="squaredFour squares">
                                        <input type="checkbox" checked value="None" disabled name="check"/>
                                        <label></label>
                                    </div>
...
<script src="__ADMINJS__/app/jurisdictionListLook.js"></script>
</body>
</html>