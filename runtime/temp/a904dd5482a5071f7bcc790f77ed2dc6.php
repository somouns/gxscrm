        ...
        <div class="layui-container">
            <div class="layui-row common-row">
                ...
                <div class="layui-col-md12">
                    <h2 class="jur-head">路由管理</h2>
                </div>
                <!-- 搜索查询等 -->
                <form action="" class="layui-form">
                    <div class="example-handle" style="text-align: right;">
                        <a href="add" data-type="tab" title="新增账号" class="examine-query" style="margin-top: 20px;"></i>新增</a>
                    </div>
                </form>
            </div>
            <table class="common-table" cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                ...
                <tr align="center">
                    ...
                    <td><?php echo $vo['ismenu']; ?></td>
                    <td><?php echo $vo['status']; ?></td>
                    <td><?php echo date("Y-m-d H:i",$vo['createtime']); ?></td>
                    <td><a href="role/edit?id=<?php echo $vo['id']; ?>">修改</a>&nbsp;&nbsp;&nbsp;<a href="de"></td>
                </tr>
