        ...
        <div class="layui-container">
            <div class="layui-tab">
                <ul class="layui-tab-title init-tab">
                    <?php if(checkAuth('/admin/contract/contract/contract_lists') == 'true'): ?>
                    <li class="layui-this">待处理合同</li>
                    <?php endif; if(checkAuth('/admin/contract/contract/contract_record_list') == 'true'): ?>
                    <li>全部处理记录</li>
                    <?php endif; ?>
                </ul>
                    ...
                    <div class="layui-tab-item content-list layui-show">
                        <div class="layui-form-item finance-search">
                            <div class="layui-input-block">
                                <form class="layui-form" action="">
                                    <input type="text" name="title" lay-verify="" @blur="searchBlur" autocomplete="off"
                                           maxlength="10" placeholder="请输入客户姓名、产品或销售人员" class="layui-input">
                        ...
                        <table class="common-table" cellpadding="0" cellspacing="0" border="0" width="100%"
                            ...
                            <tr align="center" v-if="tableDataAll.length != 0" v-for="item in tableDataAll">
                                ...
                                <td>{{item.salesman}}</td>
                                <td>
                                    <?php if(checkAuth('/admin/contract/contract/contract_view') == 'true'): ?>
                    ...
                    <div class="layui-tab-item content-list ">
                        ...
                        <div class="page" v-show="tableDataWait.length != 0">
                            <div class="page-select">
                                <span class="page-title">每页展示客户</span>
                                <ul>
                                    <li><a href="javascript:;" @click="pageNum2($event)">1000</a></li>
                                    <li><a href="javascript:;" @click="pageNum2($event)">500</a></li>
                                    <li><a href="javascript:;" @click="pageNum2($event)">300</a></li>
                                </ul>
                            </div>
                            <div class="page-choice">
                                <div id="test2"></div>
...
<script src="__ADMINJS__/app/contractManage.js"></script>
</body>
</html>