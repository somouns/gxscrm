            ...
            <div class="layui-row common-row">
                ...
                <div class="layui-col-md12 jur-top row-list fl">
                    <form class="layui-form juf-form">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="text" name="end_time" class="layui-input" id="test-stop" placeholder="yyyy-MM-dd hh:mm:ss">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="example-handle handle-add">
                            <?php if(checkAuth('/admin/group/file_group/add') == 'true'): ?>
                ...
                <table class="common-table" cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                    ...
                    <tr align="center" v-for="(item, index) in tableDataAll">
                        ...
                        <td>
                            <?php if(checkAuth('/admin/group/file_group/view') == 'true'): ?>
                            <a class="audit-skip" data-type="tab" title="查看群组" :href='"/admin/group/file_group/view?id=" + item.id'>查看</a>
                            <?php else: endif; if(checkAuth('/admin/group/file_group/edit') == 'true'): ?>
                            <a class="audit-skip" data-type="tab" title="编辑群组" :href='"/admin/group/file_group/edit?id=" + item.id'>编辑</a>
                            <?php else: endif; if(checkAuth('/admin/group/file_group/delete') == 'true'): ?>
...
<script src="__ADMINJS__/app/groupManage.js"></script>
</body>
</html>