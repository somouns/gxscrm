                ...
                <div class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block phone-box">
                            ...
                            <i class="stock-error" v-show="checkBookShow">建仓价介于跌停价与涨停价之间</i>
                        </div>
                    </div>
                    <!-- 调仓比例 -->
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block phone-box">
                            <input type="text" name="stock_win_price" required lay-verify="required" onkeyup="this.value = this.value.replace(/[^\d]/g,'')" placeholder="" class="layui-input">
                        </div>
                    </div>
                    <!-- 止损价 -->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block phone-box">
                            <input type="text" name="stock_lose_price" required lay-verify="required" onkeyup="this.value = this.value.replace(/[^\d]/g,'')" placeholder="" class="layui-input">
                        </div>
                    </div>
                    <!-- 标的负责人 -->
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="stock_teacher_id" required lay-verify="required" lay-search="">
                                    <option value="">请输入用户真实姓名，至少1个字符</option>
                                    <option value="1">layer</option>
                                    <option value="2">form</option>
                                    <option value="3">layim</option>
                                    <option value="4">element</option>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="stock_suggestcontent" placeholder="" class="layui-textarea" maxlength="1000"></textarea>
                        </div>
                    </div>
                    <!-- 操作理由 -->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="stock_info" placeholder="" class="layui-textarea" maxlength="1000"></textarea>
                        </div>
                    </div>
                    <!-- 保存与取消 -->
                    <div class="examine">
