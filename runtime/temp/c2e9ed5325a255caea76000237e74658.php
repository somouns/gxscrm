...
<link rel="stylesheet" href="__ADMINCSS__/page/service.css"/>
</head>
<body>
                ...
                <div class="layui-col-md12 jur-top row-list fl">
                    <div class="layui-form juf-form">
                        <form action="" class="layui-form">
                            ...
                            <?php if(checkAuth('/admin/service/service_record/export') == 'true'): ?>
...
<script src="__ADMINJS__/app/service.js"></script>
</body>
</html>