                ...
                <div class=" jur-row">
                    <div class="layui-form">
                        ...
                        <div class="layui-form-item custom-label">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="name" value="" placeholder="请输入权限组名称" autocomplete="off" class="layui-input username">
                            </div>
                        </div>
                        <div class="layui-form-item custom-label">
                            <label class="layui-form-label">描述：</label>
                            <div class="layui-input-block">
                                <textarea placeholder="请输入100个字符以内的描述" value="" name="describe" class="layui-textarea description" maxlength="100"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="client-nav">
                        <ul id="navigation">
                            <div class="data-jur">
                                <h2>数据权限配置：</h2>
                                <li class="open" v-for="items in dataList">
                                    <div class="squaredFour">
                                        <input type="checkbox" value="None" :data-type="items.id" :id="items.id + 1" name="check"/>
                                        <label :for="items.id + 1" class="child-select"></label>
                                    </div>
                                    <label class="labels" :for="items.id + 1">{{items.name}}</label>
                                    <ul>
                                        <li class="open end-li clearfix" v-for="lists in items.child">
                                            <div class="squaredFour">
                                                <input type="checkbox" value="None" :data-type="lists.id" :id="lists.id + 1" name="check"/>
                                                <label :for="lists.id + 1" class="child-select"></label>
                                            </div>
                                            <label class="labels" :for="lists.id + 1">{{lists.name}}</label>
                                            <ul>
                                                <li v-for="listLasts in lists.child" class="pull-left end-li">
                                                    <div class="squaredFour">
                                                        <input type="checkbox" value="None" :data-type="listLasts.id" :id="listLasts.id + 1" name="check"/>
                                                        <label :for="listLasts.id + 1" class="child-select"></label>
                                                    </div>
                                                    <label class="labels" :for="listLasts.id + 1">{{listLasts.name}}</label>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                            ...
                            <div class="rule-jur">
                                <h2>功能权限配置：</h2>
                                <li class="open" v-for="item in roleList">
                                    <div class="squaredFour">
                                        <input type="checkbox" value="None" :data-type="item.id" :id="item.id + 100" name="check"/>
                                    ...
                                    <ul>
                                        <li class="open clearfix end-li" v-for="list in item.child">
                                            <div class="squaredFour">
                                                <input type="checkbox" value="None" :data-type="list.id" :id="list.id + 100" name="check"/>
                                            ...
                                            <ul>
                                                <li v-for="listLast in list.child" class="pull-left end-li">
                                                    <div class="squaredFour">
                                                        <input type="checkbox" value="None" :data-type="listLast.id" :id="listLast.id + 100" name="check"/>
                        ...
                        <div class="examine">
                            <div class="example-handle">
                                <a @click="cancel" class="examine-reset">取消</a><a class="examine-query add-jur-save" @click="jurSave">保存</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="__ADMINJS__/app/jurisdictionListAdd.js"></script>
</body>
</html>