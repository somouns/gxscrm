            ...
            <div class="layui-row add-sign-row">
                <div class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <button class="layui-btn file" lay-data="<?php echo url("","",true,false);?>">上传附件</button>
