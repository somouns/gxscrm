            ...
            <div class="layui-row add-sign-row">
                <div class="layui-form">
                    ...
                    <div class="layui-col-md12 sign-header">
                        <h2 class="jur-head">调仓</h2>
                    </div>
                    <!-- 总仓位 -->
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <span class="total-warehouse">现价：11.01元</span>
                            <span class="total-warehouse">跌停价：<i class="sign-down">11.01元</i></span>
                            <span class="total-warehouse">涨停价：<i class="sign-add">11.01元</i></span>
                        </div>
                    </div>
                    <!-- 调仓类型 -->
                    <div class="layui-form-item">
                        <label class="layui-form-label"><span class="sign-hit">* </span>调仓类型</label>
                        <div class="layui-input-block">
                            <input type="radio" name="transfer_type" value="1" title="加仓" checked="">
                            <input type="radio" name="transfer_type" value="2" title="减仓">
                        </div>
                    </div>
                    <!-- 调仓比例 -->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="transfer_position_rate" lay-verify="scaleTest" placeholder="请输入调仓比例" @blur="spaceScale" class="layui-input">
                            <i class="stock-error" v-show="checkrateShow">总仓位不得小于0或大于10，请计算后重新输入</i>
                        </div>
                    </div>
                    <!-- 调仓价格 -->
                    <div class="layui-form-item">
                        <label class="layui-form-label"><span class="sign-hit">* </span>调仓价格</label>
                        <div class="layui-input-block">
                            <input type="text" name="buy_price" placeholder="请输入股票代码或名称，代码至少3个字符" class="layui-input">
                        </div>
                    </div>
                    <!-- 建议话术 -->
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="suggest_content" placeholder="" class="layui-textarea"></textarea>
                        </div>
                    </div>
                    <!-- 操作理由 -->
                    <div class="layui-form-item">
                    ...
                    <div class="examine">
                        <div class="example-handle">
                            <button class="examine-reset">取消</button><a class="examine-query" lay-submit lay-filter="formSpace">保存内容</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="__ADMINJS__/app/signManageSpace.js"></script>
</body>
</html>