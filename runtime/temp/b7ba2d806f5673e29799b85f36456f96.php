        ...
        <div class="layui-container">
            ...
            <div class="layui-row add-sign-row">
                <div class="layui-form">
                    ...
                    <div class="layui-col-md12 sign-header">
                        <h2 class="jur-head">研报</h2>
                    </div>
                    <!-- 研报名称 -->
                    <div class="layui-form-item">
                        <label class="layui-form-label"><span class="sign-hit">* </span>研报名称</label>
                        <div class="layui-input-block">
                            <input type="text" placeholder="请输入研报名称" class="layui-input" minlength="0" maxlength="30">
                            <i class="sign-danger">内容已到上限，最多输入30个字符</i>
                        </div>
                    </div>
                    <!-- 研报内容 -->
                    <div class="layui-form-item">
                        <label class="layui-form-label">研报内容</label>
                        <div class="layui-input-block">
                            <textarea name="desc" placeholder="请输入研报内容" class="layui-textarea" minlength="0" maxlength="1000"></textarea>
                        </div>
                    </div>
                    <!-- 操作理由 -->
                    <div class="layui-form-item">
                        ...
                        <!--<div class="layui-input-block">-->
                            <!--<button type="button" class="layui-btn test-file"><i class="layui-icon">&#xe67c;</i>上传文件</button>-->
                            <!--<span class="file-hint">（大小不得超过5M）</span>-->
                            <!--<div>-->
                                <!--<p class="file-text">XXXX海特研报.doc <span class="iconfont icon-delete"></span></p>-->
                            <!--</div>-->
                        <!--</div>-->
                        <div class="layui-input-block">
                            ...
                            <p><img src="" alt="" class="avatar"></p>
                            <div>
                                <p class="file-text"><span class="file-span"></span><i class="iconfont icon-delete"></i></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="examine">
                <div class="example-handle">
                    <button class="examine-reset">取消</button><a class="examine-query save-report">保存内容</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="__ADMINJS__/app/signManageReport.js"></script>
</body>
</html>