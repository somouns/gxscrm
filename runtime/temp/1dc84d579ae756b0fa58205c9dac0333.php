<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:89:"F:\F-Project\0-Company\CRM\gxscrm\trunk\public/../application/admin\view\index\index.html";i:1510536805;s:95:"F:\F-Project\0-Company\CRM\gxscrm\trunk\public/../application/admin\view\common\header_top.html";i:1510536805;s:98:"F:\F-Project\0-Company\CRM\gxscrm\trunk\public/../application/admin\view\common\header_bottom.html";i:1509704257;s:94:"F:\F-Project\0-Company\CRM\gxscrm\trunk\public/../application/admin\view\common\bread_nav.html";i:1509704257;s:94:"F:\F-Project\0-Company\CRM\gxscrm\trunk\public/../application/admin\view\common\side_menu.html";i:1510021729;s:99:"F:\F-Project\0-Company\CRM\gxscrm\trunk\public/../application/admin\view\common\global_message.html";i:1509704257;s:91:"F:\F-Project\0-Company\CRM\gxscrm\trunk\public/../application/admin\view\common\player.html";i:1509896789;s:95:"F:\F-Project\0-Company\CRM\gxscrm\trunk\public/../application/admin\view\common\footer_top.html";i:1509704257;s:98:"F:\F-Project\0-Company\CRM\gxscrm\trunk\public/../application/admin\view\common\footer_bottom.html";i:1509704257;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
    ...
    <title>Athena场景化金融云数据交易链系统</title>
...
<div id="app" v-cloak>
    ...
    <div class="home-header">
        <div class="layui-container">
            <h3 class="header-title">Athena场景化金融云数据交易链系统</h3>
            <div class="header-right">
                <a href="/admin/user/selectoneuser?user=my" data-type="tab" title="查看账号" class="user-photo" >
                    <img :src="userinfo.avatar" onerror="this.src='/assets/images/avatar2.png'">
                </a>
                <div class="examine-select">
                    <div class="examine-filter">
                        <a class="filter-a" @click="menu">{{userinfo.nickname}}<i class="iconfont icon-down-arrow" :class="{'rotate-i': menubar}"></i></a>
                        <ul class="filter-ul" :class="{'open':menubar}">
                            <li><a href="/admin/user/editUser?user=my" title="修改资料" data-type="tab">修改资料</a></li>
                            <li><a href="javascript:void(0);" @click="cPassword">修改密码</a></li>
                            <li><a href="javascript:void(0);" @click="logout">退出登录</a></li>
                        </ul>
                    </div>
                </div>
                <a class="email-icon" href="/admin/sms/sms/" title="消息管理" data-type="tab">
                    <i class="iconfont icon-email">
                        <span class="email-total" v-show="allview.all != 0">{{allview.all}}</span>
                        <span class="email-total" v-show="allview.all != 0 && allview.all > 99">99+</span>
                    </i>
                </a>
            </div>
        </div>
    </div>
    <div class="layui-container index-container">
        <!-- 通知列表 -->
        <div class="layui-row clearfix">
            <!-- 待处理提醒 -->
            <div class="layui-col-md4 layui-col-sm6 layui-col-xs12 home-title">
                <div class="home-dispose">
                    <div class="dispose-cont">
                        <div class="row dispose-list">
                            <div class="layui-col-md6 layui-col-sm6 layui-col-xs6 list-title">
                                <div class="list-left">
                                    <h3>{{CustomerTote.all_total}}</h3>
                                    <p>我的档案客户</p>
                                </div>
                            </div>
                            <div class="layui-col-md6 layui-col-sm6 layui-col-xs6 list-title">
                                <div class="list-left">
                                    <h3>{{CustomerTote.today_total}}</h3>
                                    <p>今日新增档案客户</p>
                                </div>
            ...
            <!-- 消息中心 -->
            <div class="layui-col-md8 layui-col-sm6 layui-col-xs12 home-message">
                <div class="row list-classify">
                    <div class="layui-col-md12 list-title">消息中心 <a href="/admin/sms/sms/" class="title-more" title="消息管理" data-type="tab">更多</a></div>
                    <div class="layui-col-md12 list-news">
                        <ul>
                            <li class="classify-li" v-for='(item, index) in newsView' v-if="item != ''">
                                <a :href="'/admin/sms/sms?type='+item.type+'&sontype='+item.sontype" title="消息管理" data-type="tab">
                                    <div class="explainBox"><span class="explain">{{item.sonname}}</span></div>
                                    <span class="details layui-elip" v-html="item.content"></span>
        ...
        <!-- 主内容分类导航 -->
        <div class="layui-row home-cont clearfix">
            <?php if(is_array($auth) || $auth instanceof \think\Collection || $auth instanceof \think\Paginator): $k = 0; $__LIST__ = $auth;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
            <div class="layui-col-md2 layui-col-sm4 layui-col-xs6 show-logo">
                <a class="show-nav" href="<?php echo $vo['url']; ?>" data-type="tab" data-title="<?php echo $vo['title']; ?>">
                    <img src="<?php echo $vo['icon']; ?>" alt="<?php echo $vo['title']; ?>">
...
<script src="__ADMINJS__/app/index.js"></script>
</body>
</html>