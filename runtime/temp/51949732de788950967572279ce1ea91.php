            ...
            <div class="layui-row common-row">
                    ...
                    <div class="layui-form juf-form">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="grade_name" lay-verify="" placeholder="请输入职级名称" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="example-handle handle-add">
                            <?php if(checkAuth('/admin/grade/addgrade') == 'true'): ?>
                            <button class="examine-query" @click="addGrade">新增职级</button>
                            <?php else: endif; ?>
                        </div>
                    </div>
                </div>
                <div class="jur-total clear">共<span class="jur-number">{{getAllListTotal}}</span>个职级</div>
                <table class="common-table" cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                    ...
                    <tr align="center" v-for="(item, index) in tableDataAll">
                        ...
                        <td>
                            <?php if(checkAuth('/admin/grade/editgrade') == 'true'): ?>
                            <a class="audit-skip" href="javascript:;" @click="gradeEdit(item.id,index)" :data-id="item.id">编辑</a>
                            <?php else: endif; if(checkAuth('/admin/grade/delgrade') == 'true'): ?>
                            <a class="audit-skip" href="javascript:;" @click="gradeDelete(item.id)" :data-id="item.id">删除</a>
                            <?php else: endif; ?>
                        </td>
                    </tr>
                    </tbody>
...
<script src="__ADMINJS__/app/gradeManage.js"></script>
</body>
</html>