        ...
        <div class="layui-container">
            <div class="layui-row rule-row">
                ...
                <div class="layui-col-md12 clear">
                    <h2 class="jur-head">添加数据权限</h2>
                </div>
                <div v-show="contractShow" class="layui-row structure-row" style="width: 500px;">
                    ...
                    <div class="example-handle">
                        <a class="examine-reset" @click="selectCancel">取消</a>
                ...
                <div action="" class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" required readonly lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input paren-canter">
                            <div class="example-handle">
                    ...
                    <div class="rule-list form-item">
                        <div class="add-import" v-for="item in dataAll">
                            <div class="layui-form-item">
                                <label class="layui-form-label">name</label>
                                <div class="layui-input-block">
                                    <input type="text" v-model="item.name" name="title" required  lay-verify="required" placeholder="请输入name" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">表名</label>
                                <div class="layui-input-block">
                                    <input type="text" v-model="item.table_name" name="title" required  lay-verify="required" placeholder="请输入表名" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">字段名</label>
                                <div class="layui-input-block">
                                    <input type="text" v-model="item.field_name" name="title" required  lay-verify="required" placeholder="请输入字段名" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <form class="layui-form form-list" action="">
                            <div class="example-handle">
                                <a class="examine-query save-name" @click="save">保存</a>
...
<script src="__ADMINJS__/app/ruleData.js"></script>
</body>
</html>