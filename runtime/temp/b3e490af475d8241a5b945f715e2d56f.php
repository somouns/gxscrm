...
<link rel="stylesheet" href="__ADMINCSS__/page/departmentManage.css"/>
</head>
<body>
        ...
        <div class="layui-container">
            <div class="layui-row structure-row">
                ...
                <div class="layui-col-md12">
                    <h2 class="jur-head depart-head">{{dataName.name}}</h2>
                </div>
                    ...
                    <div id="jstree">
                        <ul class="jstree-ul">
                            <li :data-id="item.id" class="jstree-open" v-for="(item, index) in dataParent">
                                ...
                                <span class="tree-editor">编辑</span>
                                <span class="tree-delete" :data-id="item.id" v-show="!item.child">删除</span>
                                <ul class="jstree-ul">
                                    <li :data-id="list.id" class="jstree-open" v-for="(list, index) in item.child">
                                        ...
                                        <span class="tree-editor">编辑</span>
                                        <span class="tree-delete" :data-id="list.id" v-show="!list.child">删除</span>
                                        <ul class="jstree-ul">
                                            <li :data-id="lastList.id" class="jstree-open" v-for="(lastList, index) in list.child">
                                                ...
                                                <span class="tree-editor">编辑</span>
                                                <span class="tree-delete" :data-id="lastList.id" v-show="!lastList.child">删除</span>
                                                <ul class="jstree-ul">
                                                    <li :data-id="itemFour.id" class="jstree-open" v-for="(itemFour, index) in lastList.child">
                                                        ...
                                                        <span class="tree-editor">编辑</span>
                                                        <span class="tree-delete" :data-id="itemFour.id" v-show="!itemFour.child">删除</span>
                                                        <ul class="jstree-ul">
                                                            <li :data-id="itemFive.id" class="jstree-open" v-for="(itemFive, index) in itemFour.child">
                                                                ...
                                                                <span class="tree-editor">编辑</span>
                                                                <span class="tree-delete" :data-id="itemFive.id" v-show="!itemFive.child">删除</span>
                                                                <ul class="jstree-ul">
                                                                    <li :data-id="itemSix.id" class="jstree-open" v-for="(itemSix, index) in itemFive.child">
                                                                        ...
                                                                        <span class="tree-editor">编辑</span>
                                                                        <span class="tree-delete" :data-id="itemSix.id" v-show="!itemSix.child">删除</span>
                                                                        <ul class="jstree-ul">
...
<script src="__ADMINJS__/app/departmentManageEdit.js"></script>
</body>
</html>