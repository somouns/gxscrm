...
<link rel="stylesheet" href="__ADMINCSS__/page/product-list.css" /> </head>
<body>
            ...
            <div class="layui-form layui-col-md12">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" placeholder="请输入产品名称" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">产品负责人</label>
                        <div class="layui-input-inline">
                            <input type="text" placeholder="请输入产品负责人" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline btn-box">
                        <div class="layui-input-inline">
                            <button class="layui-btn">查询</button><button class="layui-btn layui-btn-primary">重置</button>
                        </div>
                    </div>
                    <a href="javascript:;" class='layui-btn' data-type='tab'>新增产品</a>
                </div>

            </div>
            <div class="main-table layui-col-md12">
                <p class="layui-table-title">共
                    <span>120</span> 个项目</p>
                <table class="layui-table layui-col-md12" lay-skin="line">
                    <thead class="layui-col-md12">
                        <tr class="layui-col-md12">
                            ...
                            <td class="layui-col-md2 layui-elip">创建时间</td>
                            <td class="layui-col-md2 layui-elip">开始时间</td>
                            <td class="layui-col-md2 layui-elip">结束时间</td>
                            <td class="layui-col-md1">状态</td>
                            <td class="layui-col-md2">操作</td>
                        </tr>
                        <tr class="layui-col-md12" v-for="i in products">
                            <td class="layui-col-md2 layui-elip">{{i.name}}</td>
                            <td class="layui-col-md1 layui-elip">{{i.principal}}</td>
                            <td class="layui-col-md2 layui-elip">{{i.create_time}}</td>
                            <td class="layui-col-md2 layui-elip">{{i.stat_time}}</td>
                            <td class="layui-col-md2 layui-elip">{{i.end_time}}</td>
                            <td class="layui-col-md1">{{i.status}}</td>
                            <td class="layui-col-md2">
                                <a href="javascript:;">查看</a>
                                <a href="javascript:;">编辑</a>
                                <a href="javascript:;">删除</a>
                                <a href="javascript:;">出局</a>
                                <a href="javascript:;">新增标的</a>
                            </td>
                        </tr>
                    </thead>
                </table>
                <div id="product-page" class="product-page layui-col-md12"></div>
            </div>
        </div>
    </div>
</div>
