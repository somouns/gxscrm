                ...
                <div action="" class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" :value="getOneName.name" :data-id="getOneName.id" required readonly lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input paren-canter">
                            <div class="example-handle">
                    ...
                    <div class="rule-list form-item">
                        <div class="add-import">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" v-model="getOneData.name" name="title" required  lay-verify="required" placeholder="请输入name" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">表名</label>
                                <div class="layui-input-block">
                                    <input type="text" v-model="getOneData.table_name" required  lay-verify="required" placeholder="请输入表名" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">字段名</label>
                                <div class="layui-input-block">
                                    <input type="text" v-model="getOneData.field_name" required  lay-verify="required" placeholder="请输入字段名" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="__ADMINJS__/app/ruleEditData.js"></script>
</body>
</html>