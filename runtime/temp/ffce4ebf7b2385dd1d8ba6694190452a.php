...
<link rel="stylesheet" href="__ADMINCSS__/page/tags-manage.css" />
</head>
<body>
...
<!-- // 音频播放组件 end -->
	...
	<div class="main-wrap" id="app" v-cloak>
        <div class="main">
            <div class="check-btn">
                <p>
                    <a href="javascript:void(0);" class="cancel" @click="cancelAll" v-show="choiceLens">取消已选</a>
                    <a href="javascript:void(0);" @click="choiceAll">全选</a>
                </p>
            </div>
            <div class="layui-collapse">
                <div class="layui-colla-item" v-for="item in list" v-show="item.child.length">
                    <h2 class="layui-colla-title">{{item.tag_name}}</h2>
                    <div class="layui-colla-content layui-show">
                        <div class="layui-row">
                            <div class="remarks-list">
                                <ul>
                                    <li class="list-item" :class="{active: child.active}" v-for="child in item.child" @click="choice($event, child.tag_code, child.pid)">{{child.tag_name}}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="btn-box">
                <button type="reset" class="layui-btn layui-btn-primary" @click="cancelAll">取消</button>
                <button class="layui-btn" :disabled="addTagBtn" @click="addTag">确定</button>
            </div>
        </div>
    </div>
</div>
...
<script src="__ADMINJS__/app/tagsManage.js"></script>
</body>
</html>